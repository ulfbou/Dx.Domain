...
Runs manually or after relevant documentation changes reach `master`. It builds the canonical `docs/` tree through `docs/docfx.json`, uploads one site artifact, and deploys that output once to `gh-pages`.
