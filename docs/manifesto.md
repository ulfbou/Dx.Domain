> Enforced by [ADR-0003](adr/adr-0003-dxa010-warning.md) through [ADR-0016](adr/adr-0016-dxa080-facade-invariant-enforcement.md)
 Dx.Domain Manifesto
...
- [Non‑Goals](non-goals.md) – what we permanently refuse to become.
