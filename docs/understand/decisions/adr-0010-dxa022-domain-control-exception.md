## [ADR-0010](adr-0010-dxa022-domain-control-exception.md): [DXA022](../../reference/diagnostics/DXA022.md) Domain Control Exception
...
### Decision
Implement [DXA022](../../reference/diagnostics/DXA022.md) to flag exceptions used for domain control flow.
...
**Enforced by:** [DXA022](../../reference/diagnostics/DXA022.md)
