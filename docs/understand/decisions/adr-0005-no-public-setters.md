## [ADR-0005](adr-0005-no-public-setters.md): No Public Setters on Domain Types
...
**Enforced by:**
- **Code review** (primary)
- **[DXA040](../../reference/diagnostics/DXA040.md)** — prevents adding mutable public API without ADR
- **Future: [DXA060](../../reference/diagnostics/DXA060.md)** may flag "Setter" patterns
...
### Dependencies
- [ADR-0004](adr-0004-result-struct.md) (struct-based `Result` aligns with immutability)
