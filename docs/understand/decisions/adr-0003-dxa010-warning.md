...
- **[DXA010](../../reference/diagnostics/DXA010.md)** — Direct construction detection (**Moderate**) — S1–S3 only
- **[DXA011](../../reference/diagnostics/DXA011.md)** — Public factory exposure (**Moderate–Strong**) — S1–S3 only
- **[DXA080](../../reference/diagnostics/DXA080.md)** — Facade invariant presence (**Moderate**) — S1 only
...
### Dependencies
- [**DXA080**](../../reference/diagnostics/DXA080.md) required to preserve invariant intent
