...
**Enforced by:**
- **[DXA040](../../reference/diagnostics/DXA040.md)** — Kernel Public Surface Freeze (prevents addition)
- **[DXA020](../../reference/diagnostics/DXA020.md), [DXA022](../../reference/diagnostics/DXA022.md), [DXA030](../../reference/diagnostics/DXA030.md)** — enforce `Result` usage patterns
