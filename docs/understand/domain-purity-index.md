...
[Manifesto](manifesto.md) and [Non‑Goals](non-goals.md) into day‑to‑day decisions.
...
6. **Non‑Goal Compliance**  
   It violates none of the [Non‑Goals](non-goals.md). If it drifts toward
...
belongs at the edge – or not in this repo at all.
