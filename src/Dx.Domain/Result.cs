...
namespace Dx.Domain
{
    ...
    /// </summary>
    /// <remarks>The Result class offers a standardized way to construct and transform result types,
    /// supporting both value-carrying and error-carrying results. These methods simplify the creation of success and
    ...
    public static partial class Result
    {
        ...
        /// <returns>A Result object representing a successful outcome that contains the specified value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Result<TValue, TError> Success<TValue, TError>(TValue value) where TValue : notnull where TError : notnull
            => Result<TValue, TError>.Ok(value);
        ...
        /// <returns>A <see cref="Result{Unit}"/> representing a successful operation with no value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Result<Unit> Success() => Result<Unit>.Ok(Unit.Value);
        ...
        /// <returns>A successful <see cref="Result{Unit, TError}"/> instance containing no value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Result<Unit, TError> Success<TError>() where TError : notnull
            => Result<Unit, TError>.Ok(Unit.Value);
        ...
        /// <typeparam name="TValue">The type of the value contained in the result.</typeparam>
        /// <param name="result">The result instance to return. Cannot be null.</param>
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Result<Unit> From(Result<Unit> result) => result;
        ...
        public static Result<TValue, TError> From<TValue, TError>(Result<TValue> result) where TValue : notnull where TError : notnull
        {
            return result.IsSuccess
                ? Ok<TValue, TError>(result.Value)
                : Failure<TValue, TError>((TError)(object)result.Error!);
        }
    }
}
